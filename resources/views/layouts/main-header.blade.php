								...
								<div class="dropdown-menu "  >
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">  <a href="{{route('MarkAsRead_all')}}"> قراءة الكل </a></span>
										</div>
                                        <h6 style="color: yellow" id="notifications_count">
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 font-weight-semibold">   عدد الاشعارات الغير مقروءة : <span class='badge badge-pill  badge-warning mr-auto my-auto font-weight '> {{auth()->user()->unreadNotifications()->count()}}</span> </p>
                                        </h6>
									</div >
                                    <div id='unreadNotifications' class="scrollable-area" style="max-height:170px; overflow-y: auto;">
                                                ...
                                                <div class="main-notification-list Notification-scroll " >
                                                    <a class="d-flex p-3 border-bottom" href="{{url('InvoicesDetails') }}/{{ $notification->data['id'] }}">
                                                        ...
                                                        <div class="mr-3">
                                                            ...
                                                            <div class="notification-subtext">{{$notification->created_at}} hour ago</div>
                                                        </div>
                                                        <div class="mr-auto" >
