                                        ...
                                        <div class="tab-pane" id="tab5">
                                            <div class="table-responsive mt-15">
                                                <table class="table center-aligned-table mb-0 table-hover"
                                                    ...
                                                    <tbody>
                                                        <?php $i=0 ?>
                                                       @foreach ( $invoices_detailes as $detailes )
                                                       <?php $i++?>
                                                            <tr>
                                                                <td>{{ $i }}</td>
                                                                <td>{{ $detailes->invoice_number }}</td>
                                                                <td>{{ $detailes->product }}</td>
                                                                <td>{{ $detailes->Section }}</td>
                                                                <td>{{ $detailes->Status}}</td>

                                                                <td>{{ $detailes->created_at }}</td>
                                                                <td>{{ $detailes->note }}</td>
                                                                <td>{{ $detailes->user}}</td>
