...
@section('content')
            ...
            <script>
                window.onload = function() {
                    notif({
                        msg: "تم الفاء أرشفة الفاتورة بنجاح",
                        type: "success"
                    })
                }
                                               ...
                                               <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div  class="dropdown-menu tx-13">
                                                            @can('تعديل الفاتورة')
                                                            <a class="dropdown-item" href="{{ route('edit-invoice',$invoice->id) }}"><i class="text-sucess las la-pen"></i>update</a>
                                                            @endcan

                                                            @can('حذف الفاتورة')
                                                            <a class="dropdown-item" href="{{ route('delete-invoice',$invoice->id) }}"><i
